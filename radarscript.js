...
function getAlert(polycoords){
    ...
    if (alertInfo.properties.description.includes("considerable")){alertInfo.properties.description.includes("DESTRUCTIVE")
...
// Improved function to remove expired watches
...
setInterval(removeExpiredWatches, 120000);